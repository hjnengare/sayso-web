...
export default function SpecialHeroImage({ special, isLiked = false, onLike }: SpecialHeroImageProps) {
    ...
    return (
        <motion.div
            ...
            className="relative w-full aspect-[16/10] sm:aspect-[16/9] bg-gradient-to-br from-card-bg via-card-bg to-card-bg/95 rounded-[20px] overflow-hidden border border-white/60 backdrop-blur-xl shadow-md"
        >
            <Image
                src={imageSrc}
