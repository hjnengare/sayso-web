...
export function VerificationForm({ business, onClose, onSuccess }: VerificationFormProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="bg-off-white rounded-[20px] shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
        {/* Header */}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          {/* Business Info */}
          <div className="bg-white/50 rounded-[20px] p-4 border border-charcoal/10">
          ...
          <div className="space-y-3">
            ...
            {/* Email Verification */}
            <label className={`flex items-start gap-3 p-4 rounded-[20px] border-2 cursor-pointer transition-all ${
