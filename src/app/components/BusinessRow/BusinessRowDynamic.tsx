    ...
    <div className="container mx-auto max-w-[2000px] px-2 relative z-10">
      ...
      <ScrollableSection>
        ...
        <div className="flex gap-3 items-stretch pt-2">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="snap-start snap-always flex-shrink-0 w-[100vw] sm:w-auto sm:min-w-[25%] md:min-w-[25%] xl:min-w-[25%] list-none flex business-card-skeleton-full-width">
