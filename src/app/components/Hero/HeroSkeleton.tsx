...
export default function HeroSkeleton() {
  return (
    <div className="relative w-full px-0 py-0 md:pt-2 md:px-2">
      ...
      <section className="relative h-[100dvh] sm:h-[90dvh] md:h-[80dvh] w-full overflow-hidden outline-none rounded-none min-h-[420px] sm:min-h-[520px] sm:max-h-[820px]">
        ...
        <div className="absolute inset-0 z-20 flex items-center justify-center w-full pt-[var(--safe-area-top)] sm:pt-[var(--header-height)] translate-y-0 sm:-translate-y-4 px-6 sm:px-10">
          <div className="w-full max-w-3xl flex flex-col items-center justify-center text-center pb-12 sm:pb-20">
            ...
            <div className="h-[26px] sm:h-[29px] lg:h-[33px] bg-white/30 rounded w-72 sm:w-96 lg:w-[28rem] max-w-xl mx-auto animate-pulse mb-5 sm:mb-6" />
