...
export default function EventContactInfo({ event }: EventContactInfoProps) {
  return (
    <motion.div
      ...
      className="bg-gradient-to-br from-card-bg via-card-bg to-card-bg/95 backdrop-blur-xl border border-white/40 rounded-[12px] ring-1 ring-white/30 p-4 sm:p-6 relative overflow-hidden"
    >
