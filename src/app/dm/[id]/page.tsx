                                ...
                                {isMenuOpen && menuPosition && createPortal(
                                    <AnimatePresence>
                                        <motion.div
                                            ...
                                            className="fixed z-[1000] bg-off-white rounded-xl sm:rounded-2xl border border-white/60 shadow-[0_8px_32px_rgba(0,0,0,0.12),0_4px_16px_rgba(0,0,0,0.08)] overflow-hidden min-w-[180px] sm:min-w-[200px] backdrop-blur-xl"
                                            style={{
                        ...
                        <div className="max-w-3xl mx-auto py-4 sm:py-6 space-y-3 sm:space-y-4">
                            {messages.map((msg) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div
                                            className={`max-w-[85%] sm:max-w-[75%] md:max-w-[65%] lg:max-w-[60%] rounded-xl sm:rounded-2xl px-3 py-2.5 sm:px-4 sm:py-3 ${
                                                isCurrentUser
